...
export class AppointmentsController {
  ...
  // ── Static GET routes FIRST (before any :id routes) ──────────────────────
  ...
  // GET /appointments/admin/refunds
  @Get('admin/refunds')
  findPendingRefunds() {
  ...
  // ── Refund PATCH routes BEFORE generic :id routes ─────────────────────────
  // IMPORTANT: These must come before @Get(':id') and @Put(':id') etc.
  // Otherwise NestJS matches :id first and never reaches these routes.
